...
function getBotResponse(input) {
    ...
    if (lowerInput.includes('hola')) {
        ...
        return 'Por favor, describe tu problema y estaré encantado de ayudarte. Si necesitas más asistencia, por favor visita nuestra página de <a href="../contacto.html">contacto</a>.';  // Ajuste de ruta
